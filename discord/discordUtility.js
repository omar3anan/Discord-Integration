...
// POST request to send a message to a Discord channel
...
//     res.status(200).json({ question: questionResponse.data });
//   } catch (error) {
//     console.error(error);
//     res
//       .status(500)
...
// GET request to fetch messages from a Discord channel
